...
<head>
    ...
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .menu-btn:hover { background: var(--bg); color: var(--txt-1); }
    ...
    .bc-home { color: var(--txt-3); }
    .bc-sep  { color: var(--txt-3); font-size: 0.6rem; }
    .bc-curr { color: var(--txt-1); font-weight: 600; }
    ...
    .stat-card.c-indigo::after  { background: linear-gradient(90deg,var(--indigo),var(--violet)); }
    .stat-card.c-emerald::after { background: linear-gradient(90deg,var(--emerald),var(--cyan)); }
    .stat-card.c-amber::after   { background: linear-gradient(90deg,var(--amber),#f97316); }
    .stat-card.c-rose::after    { background: linear-gradient(90deg,var(--rose),#e879f9); }
    ...
    .stat-ico.c-indigo  { background: rgba(99,102,241,0.1);  color: var(--indigo); }
    .stat-ico.c-emerald { background: rgba(16,185,129,0.1);  color: var(--emerald); }
    .stat-ico.c-amber   { background: rgba(245,158,11,0.1);  color: var(--amber); }
    .stat-ico.c-rose    { background: rgba(244,63,94,0.1);   color: var(--rose); }
    ...
    .data-card-title i { color: var(--indigo); }
    ...
    .bdg-active    { background: rgba(16,185,129,0.1);  color: #059669; }
    .bdg-draft     { background: rgba(245,158,11,0.1);  color: #d97706; }
    .bdg-completed { background: rgba(99,102,241,0.1);  color: var(--indigo); }
    ...
    .f-label .req { color: var(--rose); margin-left: 2px; }
    ...
    .total-item-val.c-indigo  { color: var(--indigo); }
    .total-item-val.c-emerald { color: var(--emerald); }
    .total-item-val.c-amber   { color: var(--amber); }
    .total-item-val.c-rose    { color: var(--rose); }
    ...
    .alert-ico { font-size: 0.95rem; margin-top: 1px; flex-shrink: 0; }
    ...
    .empty-ico { font-size: 2.8rem; margin-bottom: 0.9rem; opacity: 0.35; }
    .empty h5 { color: var(--txt-2); font-weight: 600; margin-bottom: 0.4rem; }
...
<div class="app-wrap">
    ...
    <aside class="sidebar" id="sidebar">
        ...
        <div class="sb-logo">
            ...
            <div>
                <span class="sb-logo-title">BL Manager</span>
        ...
        <nav class="sb-nav">
            ...
            <a href="dashboard.php" class="sb-link <?php echo $current=='dashboard.php'?'active':''; ?>">
                <div class="sb-link-ico"><i class="fas fa-house"></i></div>
                <span>Dashboard</span>
                <i class="fas fa-chevron-right sb-link-arrow"></i>
            </a>

            <a href="add-bl.php" class="sb-link <?php echo $current=='add-bl.php'?'active':''; ?>">
                <div class="sb-link-ico"><i class="fas fa-circle-plus"></i></div>
                <span>Add B/L</span>
                <i class="fas fa-chevron-right sb-link-arrow"></i>
            </a>

            <a href="manage-bl.php" class="sb-link <?php echo $current=='manage-bl.php'?'active':''; ?>">
                <div class="sb-link-ico"><i class="fas fa-list-check"></i></div>
                <span>Manage B/L</span>
                <i class="fas fa-chevron-right sb-link-arrow"></i>
            </a>

            <a href="reports.php" class="sb-link <?php echo $current=='reports.php'?'active':''; ?>">
            ...
            <a href="profile.php" class="sb-link <?php echo $current=='profile.php'?'active':''; ?>">
