...
<style>
/* BL Number field special styling */
...
<div class="alert-m alert-success">
    ...
    <div>
        Bill of Lading <strong style="font-family:monospace;"><?php echo htmlspecialchars($success); ?></strong>
        created successfully!
        &nbsp;
        <a href="dashboard.php" style="color:var(--emerald);font-weight:700;">
            View Dashboard →
        </a>
    </div>
</div>
    ...
    <div class="form-card">
        ...
        <div class="form-card-body">
            <div class="row g-3">
                ...
                <!-- BL Number — full width, prominent -->
                <div class="col-12">
                    <label class="f-label">
...
<script>
/* ── BL Number live availability check ── */
let blCheckTimer;
