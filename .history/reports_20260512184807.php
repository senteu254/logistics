...
.rs-ico.c-indigo  { background:rgba(99,102,241,0.1);  color:var(--indigo); }
.rs-ico.c-emerald { background:rgba(16,185,129,0.1);  color:var(--emerald); }
.rs-ico.c-amber   { background:rgba(245,158,11,0.1);  color:var(--amber); }
.rs-ico.c-rose    { background:rgba(244,63,94,0.1);   color:var(--rose); }
.rs-ico.c-cyan    { background:rgba(6,182,212,0.1);   color:var(--cyan); }
.rs-ico.c-violet  { background:rgba(139,92,246,0.1);  color:var(--violet); }
...
.chart-title i { color: var(--indigo); }
...
.rn-gold   { background:rgba(245,158,11,0.15);  color:#d97706; }
.rn-silver { background:rgba(148,163,184,0.15); color:#64748b; }
.rn-bronze { background:rgba(180,83,9,0.12);    color:#b45309; }
.rn-other  { background:var(--bg);              color:var(--txt-3); }
...
<div class="row g-3 mb-2">
    <div class="col-md-4">
        <div class="report-stat c-amber">
            ...
            <div>
                <div class="rs-val"><?php echo number_format($totalGross/1000,2); ?>t</div>
    ...
    <div class="col-md-4">
        <div class="report-stat c-emerald">
            ...
            <div>
                <div class="rs-val"><?php echo number_format($totalNet/1000,2); ?>t</div>
    ...
    <div class="col-md-4">
        <div class="report-stat c-rose">
            ...
            <div>
                <div class="rs-val"><?php echo number_format($totalTare/1000,2); ?>t</div>
                ...
                <table class="tbl" id="monthlyTbl">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="mini-bar-wrap">
                                    <span style="font-weight:600;min-width:48px;"><?php echo number_format($m['gross']/1000,2); ?></span>
                                    <div class="mini-bar-track">
                                        <div class="mini-bar-fill" style="width:<?php echo $grossPct; ?>%;background:linear-gradient(90deg,var(--amber),#f97316);"></div>
                                    </div>
                                </div>
                            </td>
                            <td style="font-weight:600;color:var(--emerald);"><?php echo number_format($m['net']/1000,2); ?></td>
                            <td style="font-weight:600;color:var(--txt-2);"><?php echo number_format(($m['gross']-$m['net'])/1000,2); ?></td>
                        </tr>
                        <?php endforeach; ?>
                    </tbody>
                    <tfoot>
                        ...
                        <tr style="background:#f8fafc;border-top:2px solid var(--border);">
                            ...
                            <td style="padding:11px 15px;font-weight:800;color:var(--amber);"><?php echo number_format($sumGross/1000,2); ?></td>
                            <td style="padding:11px 15px;font-weight:800;color:var(--emerald);"><?php echo number_format($sumNet/1000,2); ?></td>
                            <td style="padding:11px 15px;font-weight:800;color:var(--txt-2);"><?php echo number_format(($sumGross-$sumNet)/1000,2); ?></td>
                        </tr>
                    </tfoot>
                </table>
            </div>
        ...
        options: {
            ...
            scales: {
                ...
                y: {
                    ...
                    grid: { color: 'rgba(0,0,0,0.04)' },
                    border: { display: false },
                    ticks: { callback: v => (v / 1000).toFixed(1) + 't' }
                }
            }
        }
    });
...
/* ══ CSV Export ══ */
function exportCSV() {
    const rows = [['Month','B/Ls','Containers','Total Bags','Gross (t)','Net (t)','Tare (t)']];
