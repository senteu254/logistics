...
$dispatch_total     = getCount($pdo, "SELECT COUNT(*) FROM dispatches");
$dispatch_transit   = getCount($pdo, "SELECT COUNT(*) FROM dispatches WHERE status='transit'");
$dispatch_received  = getCount($pdo, "SELECT COUNT(*) FROM dispatches WHERE status='received'");
$dispatch_rejected  = getCount($pdo, "SELECT COUNT(*) FROM dispatches WHERE status='rejected'");
*/

/* OPTIONAL: EMPTY RETURN METRICS
$empty_in_transit = getCount($pdo, "SELECT COUNT(*) FROM empty_returns WHERE return_status='in_transit'");
$empty_completed  = getCount($pdo, "SELECT COUNT(*) FROM empty_returns WHERE return_status='completed'");
*/
