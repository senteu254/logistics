...
.bl-type-option { flex: 1; position: relative; }
...
.bl-type-option:last-child .bl-type-label { border-right: none; }

.bl-type-label .type-icon  { font-size: 1.4rem; transition: var(--t); }
.bl-type-label .type-name  { font-size: 0.9rem; font-weight: 700; color: var(--txt-2); transition: var(--t); }
.bl-type-label .type-desc  { font-size: 0.7rem; color: var(--txt-3); font-weight: 400; line-height: 1.4; transition: var(--t); }
...
.return-date-info.urgent  { background:rgba(244,63,94,0.08); color:var(--rose);   border:1px solid rgba(244,63,94,0.2);   display:flex; }
.return-date-info.warning { background:rgba(245,158,11,0.08); color:var(--amber); border:1px solid rgba(245,158,11,0.2);  display:flex; }
.return-date-info.ok      { background:rgba(16,185,129,0.08); color:var(--emerald);border:1px solid rgba(16,185,129,0.2); display:flex; }
</style>
