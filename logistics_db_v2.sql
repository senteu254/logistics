...
CREATE TABLE `dispatches` (
  ...
  `notes` text,
  `redirected_destination_id` int(11) DEFAULT NULL,
  ...
  KEY `redirected_destination_id` (`redirected_destination_id`),
  KEY `dispatched_by` (`dispatched_by`),
  KEY `received_by` (`received_by`),
  CONSTRAINT `dispatches_ibfk_1` FOREIGN KEY (`bl_item_id`) REFERENCES `bl_items` (`id`) ON DELETE CASCADE,
  CONSTRAINT `dispatches_ibfk_2` FOREIGN KEY (`transporter_id`) REFERENCES `transporters` (`id`),
  CONSTRAINT `dispatches_ibfk_3` FOREIGN KEY (`destination_id`) REFERENCES `locations` (`id`),
  CONSTRAINT `dispatches_ibfk_4` FOREIGN KEY (`redirected_destination_id`) REFERENCES `locations` (`id`),
  CONSTRAINT `dispatches_ibfk_5` FOREIGN KEY (`dispatched_by`) REFERENCES `users` (`id`) ON DELETE SET NULL,
  CONSTRAINT `dispatches_ibfk_6` FOREIGN KEY (`received_by`) REFERENCES `users` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `empty_returns` (
  ...
  `local_depot_id` int(11) DEFAULT NULL,
  ...
  KEY `local_depot_id` (`local_depot_id`),
  KEY `created_by` (`created_by`),
  KEY `completed_by` (`completed_by`),
  CONSTRAINT `empty_returns_ibfk_1` FOREIGN KEY (`dispatch_id`) REFERENCES `dispatches` (`id`) ON DELETE CASCADE,
  CONSTRAINT `empty_returns_ibfk_2` FOREIGN KEY (`depot_id`) REFERENCES `locations` (`id`),
  CONSTRAINT `empty_returns_ibfk_3` FOREIGN KEY (`local_depot_id`) REFERENCES `locations` (`id`),
...
-- Dump completed on 2026-05-18  9:48:23
